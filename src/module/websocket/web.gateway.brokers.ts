...
import { getBroker } from '../resdis/redis.store';
...
@WebSocketGateway({ path: process.env.WS_WEB_BROKER_INFO_PATH || '/broker-info' })
export class SimpleGateway_WEB_BROKERS implements OnModuleInit, OnModuleDestroy {
  ...
  handleConnection(client: WebSocket, req: any) {
    ...
    client.send(JSON.stringify({
      type: 'connected',
      message: 'Connected to Server for Brokers',
      clientId: clientId,
    }));
